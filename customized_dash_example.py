...
## taken from https://plotly.com/~jackp/17561/import-dash-from-dashdependencies-impor/#/
## removed all references to 'seamless' that made it pretty, but not supported by modern browsers
